$(function(){
	...
	var margin = {top: 0, right: 0, bottom: 0, left: 0},
			mapRatio = 0.5,
			width = parseInt(d3.select("#d3-container").style("width")) - margin.left - margin.right,
	...
	function ready(error, world, population, data) {
		...
		var scaleY = d3.scaleLinear().domain([1,10]).range([0,100]);
		...
		function resize() {
		    ...
		    width = parseInt(d3.select('#d3-container').style('width'));
